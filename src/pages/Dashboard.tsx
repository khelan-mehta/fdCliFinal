...
const Dashboard = () => {
  ...
  const applyFilters = async () => {
    ...
    const res = await fetch(
      `https://server-fd.vercel.app/api/transactions/search?${params}`
    );
  ...
  useEffect(() => {
    fetch("https://server-fd.vercel.app/api/transactions/flagged-users")
      .then((res) => res.json())
  ...
  const fetchLaunderingCategories = async () => {
    try {
      const response = await axios.get(
        `https://server-fd.vercel.app/api/transactions/laundering/categories`
      );
  ...
  useEffect(() => {
    const fetchFraudData = async () => {
      try {
        const response = await axios.get(
          "https://server-fd.vercel.app/api/transactions/laundering"
